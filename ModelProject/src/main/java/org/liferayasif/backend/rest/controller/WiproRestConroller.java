...
public class WiproRestConroller {
	...
	public List<Wipro> salary(@RequestParam("avgSalary") double avgSalary){
		List<Wipro> wiproList =wiproService.getWiproByAvgSalary(avgSalary);
		System.out.println(wiproList);
		return wiproList;
	}
