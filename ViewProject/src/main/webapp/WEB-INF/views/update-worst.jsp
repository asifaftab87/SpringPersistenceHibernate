...
<body>
            <form:form  method="POST"  action="updateDetail" name="regForm" id="regForm" modelAttribute="worst">
                ...
                <table align="left">
                	...
                	<tr>
	                    ...
	                    <td><form:input type="text" path="birthDate" id="birthDate"  placeholder="dd/mm/yyyy"/></td>
                	</tr>
